 ...
 * 
 */
public class KscLyricsParserUtil {
	/**
	 * 歌曲名 字符串
	 */
	 ...
	 * TreeMap，用于封装每行的歌词信息
	 */
	private TreeMap<Integer, KscLyricsLineInfo> lyricsLineTreeMap = null;
	 ...
	 *            文件名
	 */
	public KscLyricsParserUtil(String kscFilePath) {
	 ...
	 * @throws IOException
	 */
	public void parserksc(BufferedReader br) throws NumberFormatException,
			IOException {
